...
class PolygonFromCSV:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PolygonFromCSV_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&PolygonFromCSVData')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'PolygonFromCSV')
        self.toolbar.setObjectName(u'PolygonFromCSV')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PolygonFromCSV', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/polygon_from_csv/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'PolygonFromCSVData'),
            callback=self.run,
